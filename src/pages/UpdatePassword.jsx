        ...
        {!isSuccess ? (
          <>
            <div className="text-center mb-6">
              <h2 className="text-3xl font-extrabold text-gray-900 font-sans tracking-tight">Update Password</h2>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              {/* Password */}
              <div>
                <label htmlFor="password" className="block text-sm font-bold text-gray-900 mb-1.5">New Password</label>
              ...
              {/* Confirm Password */}
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-bold text-gray-900 mb-1.5">Confirm New Password</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Lock className="h-5 w-5 text-gray-800" />
                  </div>
              ...
              >
                {isLoading ? (
                  ...
                  <>Save and Update Password <ArrowRight className="h-4 w-4" /></>
                )}
              </button>
            </form>
          </>
          ...
          <div className="text-center py-6">
            ...
            <button 
              ...
              className="w-full py-3 px-4 rounded-xl text-base font-bold text-white bg-gradient-to-r from-nagpur-blue-primary to-blue-600 hover:from-blue-600 hover:to-blue-700 shadow-md transition-all cursor-pointer"
            >
              Go to Login
            </button>
          </div>
